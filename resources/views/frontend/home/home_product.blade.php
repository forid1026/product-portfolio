                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-sm-6">
                                <div class="tp-product-item transition-3 mb-25">
                                    <div class="tp-product-thumb p-relative fix m-img">
                                        <a href="{{ route('product.details')}}">
                                            <img src="{{ asset('frontend/assets/img/product/product-2.jpg') }}"
                                                alt="product-electronic">
                                        </a>
                            ...
                            <div class="col-xl-3 col-lg-3 col-sm-6">
                                <div class="tp-product-item transition-3 mb-25">
                                    <div class="tp-product-thumb p-relative fix m-img">
                                        <a href="{{ route('product.details')}}">
                                            <img src="{{ asset('frontend/assets/img/product/product-4.jpg') }}"
                                                alt="product-electronic">
                                        </a>
                            ...
                            <div class="col-xl-3 col-lg-3 col-sm-6">
                                <div class="tp-product-item transition-3 mb-25">
                                    <div class="tp-product-thumb p-relative fix m-img">
                                        <a href="{{ route('product.details')}}">
                                            <img src="{{ asset('frontend/assets/img/product/product-5-1.jpg') }}"
                                                alt="product-electronic">
                                        </a>
                            ...
                            <div class="col-xl-3 col-lg-3 col-sm-6">
                                <div class="tp-product-item transition-3 mb-25">
                                    <div class="tp-product-thumb p-relative fix m-img">
                                        <a href="{{ route('product.details')}}">
                                            <img src="{{ asset('frontend/assets/img/product/product-5-2.jpg') }}"
                                                alt="product-electronic">
                                        </a>
                            ...
                            <div class="col-xl-3 col-lg-3 col-sm-6">
                                <div class="tp-product-item transition-3 mb-25">
                                    <div class="tp-product-thumb p-relative fix m-img">
                                        <a href="{{ route('product.details')}}">
                                            <img src="{{ asset('frontend/assets/img/product/product-5-3.jpg') }}"
                                                alt="product-electronic">
                                        </a>
