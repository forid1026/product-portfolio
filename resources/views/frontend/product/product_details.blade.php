                     ...
                     <div class="tab-content m-img" id="productDetailsNavContent">
                        <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                           <div class="tp-product-details-nav-main-thumb">
                              <img src="{{ asset('frontend/assets/img/product/details/main/product-details-main-1.jpg')}}" alt="">
                           </div>
                        </div>
                                 ...
                                 <div class="col-xl-10">
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-lg-6">
                                             <div class="tp-product-details-desc-thumb">
                                                <img src="{{ asset('frontend/assets/img/product/details/desc/product-details-desc-1.jpg')}}" alt="">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="tp-product-details-desc-item  pb-75">
                                       <div class="row">
                                          ...
                                          <div class="col-lg-7">
                                             <div class="tp-product-details-desc-thumb">
                                                <img src="{{ asset('frontend/assets/img/product/details/desc/product-details-desc-2.jpg')}}" alt="">
                                             </div>
                                          </div>
                                       ...
                                       <div class="row">
                                          <div class="col-xl-12">
                                             <div class="tp-product-details-desc-banner text-center m-img">
                                                ...
                                                <img src="{{ asset('frontend/assets/img/product/details/desc/product-details-desc-3.jpg')}}" alt="">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                       ...
                                       <div class="tp-product-details-review-list pr-110">
                                          ...
                                          <div class="tp-product-details-review-avater d-flex align-items-start">
                                             <div class="tp-product-details-review-avater-thumb">
                                                <a href="#">
                                                   <img src="{{ asset('frontend/assets/img/users/user-1.jpg')}} " alt="">
                                                </a>
                                             </div>
                  ...
                  <div class="swiper-wrapper">
                        ...
                        <div class="tp-product-item-3 tp-product-style-primary mb-50">
                           <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                              <a href="product-details.html">
                                 <img src="{{ asset('frontend/assets/img/product/related/product-related-1.jpg')}}" alt="">
                              </a>
                     ...
                     <div class="swiper-slide">
                        <div class="tp-product-item-3 tp-product-style-primary mb-50">
                           <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                              <a href="product-details.html">
                                 <img src="{{asset('frontend/assets/img/product/related/product-related-2.jpg')}}" alt="">
                              </a>
                     ...
                     <div class="swiper-slide">
                        <div class="tp-product-item-3 tp-product-style-primary mb-50">
                           <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                              <a href="product-details.html">
                                 <img src="{{asset('frontend/assets/img/product/related/product-related-3.jpg')}}" alt="">
                              </a>
                     ...
                     <div class="swiper-slide">
                        <div class="tp-product-item-3 tp-product-style-primary mb-50">
                           <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                              <a href="product-details.html">
                                 <img src="{{asset('frontend/assets/img/product/related/product-related-4.jpg')}}" alt="">
                              </a>
