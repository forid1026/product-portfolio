                                ...
                                <div class="tp-shop-widget-categories">
                                    <ul>
                                        @foreach ($categories as $category)
                                            <li>
                                                <a class="{{ $category->id == $categoryInfo->id ? 'active' : '' }}"
                                                    href="{{ route('product.category.name', $category->id) }}">{{ $category->name }}
                                                    <span>
                                                        @php
                                ...
                                <div class="col-xl-6">
                                    <div class="tp-shop-top-left d-flex align-items-center ">
                                        ...
                                        <div class="tp-shop-top-result">
                                            @php
                                                $totalProduct = App\Models\Product::where('category_id', $categoryInfo->id)->count();
                                            @endphp
                                            <p>Showing 1–12 of {{ $totalProduct }} results</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                ...
                <div class="tp-product-modal-content d-lg-flex align-items-start">
                        ...
                        <div class="tab-content m-img" id="productDetailsNavContent">
                            <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                ...
                                <div class="tp-product-details-nav-main-thumb">
                                    <img class="img-thumbnail" src="{{ asset($product->image) }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tp-product-details-wrapper">
                        ...
                        <div class="tp-product-details-action-wrapper">
                            ...
                            <a class="tp-product-details-buy-now-btn w-100"
                                href="{{ route('product.details', $product->slug) }}">Product Details</a>
                        </div>
                    </div>
                </div>
            </div>
