                ...
                <div class="col-xl-12 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="custom-validation" action="{{ route('store.product') }}" id="form" method="POST"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <textarea name="description" id="editor" cols="30" rows="10" required
                                                data-parsley-required-message="Product Details is required"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <div class="col text-secondary">
                                                ...
                                                data-parsley-required-message="Product Image is required">
                                            </div>
